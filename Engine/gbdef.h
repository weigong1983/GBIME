...
enum GBEventEnum{
	...
	, GBKEY_AMB_SPECIAL_A = 0x80	///< 在中文模式下面输入分隔符，在Alphabetic改变大小写
	, GBKEY_AMB_SPECIAL_B			///< 默认不处理，可以设置标点符号
	, GBKEY_AMB_SPECIAL_C			///< 默认不处理，
	, GBKEY_AMB_SPECIAL_D			///< 默认不处理，
	, GBKEY_AMB_SPECIAL_E			///< 默认不处理，
...
enum GBReturnEnum{
	...
	, GBE_API_INVALID_PARAM				///<\ref 函数的参数至少包含一个无效参数
	, GBE_API_GBIS_IS_NULL				///<\ref 函数的参数pGBIS为NULL
