...
////start[2010-7-29 zhj]
//#if defined(_C166)
//int gbmemcmphhb(GBLPVOID p1, GBLPVOID p2, size_t len);
//#define memcmp gbmemcmphhb
//void gbmemsethb(GBLPVOID p1, int value, size_t len);
//#define memset gbmemsethb
//GBLPVOID gbmemmovehhb (GBLPVOID dest0, GBLPCVOID source0, size_t length);
//#define memmove gbmemmovehhb
//#endif
////end[2010-7-29 zhj]
