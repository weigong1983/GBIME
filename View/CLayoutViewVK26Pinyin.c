/***************************************************************************
* File Name    :  CLayoutViewVK26Pinyin.c
...
GBIMELOCAL GBIMEReturn CLayoutViewVK26Pinyin__Paint(GBLPVOID pltObj, PEngineOutputInfo pEngineOutputInfo);

// 本地函数声明
GBIMELOCAL void ICLayoutViewVK26Pinyin__DrawCandidateLine(GBLPVOID pltObj, PEngineOutputInfo pEngineOutputInfo);
GBIMELOCAL void ICLayoutViewVK26Pinyin__DrawAssociateLine(GBLPVOID pltObj, PEngineOutputInfo pEngineOutputInfo);

CLayoutViewAbstract * CLayoutViewVK26Pinyin__Construct(PCLayoutViewVK26Pinyin pltViewVK26)
{
	CLayoutViewVK__Construct(&pltViewVK26->m_ltParent);
	CLayoutViewVK26Pinyin__Init(pltViewVK26);
	return (CLayoutViewAbstract *)pltViewVK26;
}

GBIMEReturn CLayoutViewVK26Pinyin__Init(PCLayoutViewVK26Pinyin pltViewVK26)
{
	pltViewVK26->m_ltParent.m_ltParent.m_pfcPaint = CLayoutViewVK26Pinyin__Paint;
	return GBIME_OK;
}
...
GBIMELOCAL GBIMEReturn CLayoutViewVK26Pinyin__Paint(GBLPVOID pltObj, PEngineOutputInfo pEngineOutputInfo)
{
	...
	CLASS_VIEW_THIS_POITER(CLayoutViewVK26Pinyin, pltThis)
	...
	if ((pltRoot->m_refreshFlag & GBIME_LAYOUT_REFRESH_CANDIDATE_LINE) == GBIME_LAYOUT_REFRESH_CANDIDATE_LINE)
	{
		...
		case FirstLayer:
			break;
		case SecondLayer:
			ICLayoutViewVK26Pinyin__DrawCandidateLine(pltObj, pEngineOutputInfo);
			break;
		case ThirdLayer:
			ICLayoutViewVK26Pinyin__DrawAssociateLine(pltObj, pEngineOutputInfo);
			break;
		default:
			PT_Assert(0);
			break;
...
*/
static void ICLayoutViewVK26Pinyin__DrawCandidateLine(GBLPVOID pltObj, PEngineOutputInfo pEngineOutputInfo)
{
	CLASE_THIS_POITER(CLayoutVK26Pinyin, pltObj)
	CLASS_VIEW_THIS_POITER(CLayoutViewVK26Pinyin, pltThis)
	...
	// 打印Log信息
	PT_PrintLogInfo(GBLOG_LAYOUTVIEW, ("***********************ICLayoutViewVK26Pinyin__DrawCandidateLine() Draw Candidate image\n"));
...
*/
static void ICLayoutViewVK26Pinyin__DrawAssociateLine(GBLPVOID pltObj, PEngineOutputInfo pEngineOutputInfo)
{
	CLASE_THIS_POITER(CLayoutVK26Pinyin, pltObj)
	CLASS_VIEW_THIS_POITER(CLayoutViewVK26Pinyin, pltThis)
	...
	if (pLayerConstInfo != NULL)
	{
		...
		// 打印Log信息
		PT_PrintLogInfo(GBLOG_LAYOUTVIEW, ("***********************ICLayoutViewVK26Pinyin__DrawAssociateLine() Draw Candidate image\n"));
		PT_PrintLogInfo(GBLOG_LAYOUTVIEW, ("***********************Candidate Image ID = %d\n",iCandidateNomalImageId));
