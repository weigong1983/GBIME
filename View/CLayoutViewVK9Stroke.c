/***************************************************************************
* File Name    :  CLayoutViewVK9Stroke9Stroke.c
...
GBIMELOCAL GBIMEReturn CLayoutViewVK9Stroke__Paint(GBLPVOID pltObj, PEngineOutputInfo pEngineOutputInfo);

// 本地函数声明
GBIMELOCAL void ICLayoutViewVK9Stroke__DrawCandidateLine(GBLPVOID pltObj, PEngineOutputInfo pEngineOutputInfo);
GBIMELOCAL void ICLayoutViewVK9Stroke__DrawAssociateLine(GBLPVOID pltObj, PEngineOutputInfo pEngineOutputInfo);
...
CLayoutViewAbstract * CLayoutViewVK9Stroke__Construct(PCLayoutViewVK9Stroke pltViewVK)
{
	...
	CLayoutViewVK9Stroke__Init(pltViewVK);
...
{
	pltViewVK->m_ltParent.m_ltParent.m_pfcPaint = CLayoutViewVK9Stroke__Paint;
	return GBIME_OK;
}
...
GBIMELOCAL GBIMEReturn CLayoutViewVK9Stroke__Paint(GBLPVOID pltObj, PEngineOutputInfo pEngineOutputInfo)
{
	...
	CLASS_VIEW_THIS_POITER(CLayoutViewVK9Stroke, pltThis)
	...
	if ((pltRoot->m_refreshFlag & GBIME_LAYOUT_REFRESH_CANDIDATE_LINE) == GBIME_LAYOUT_REFRESH_CANDIDATE_LINE)
	{
		...
		case FirstLayer:
			break;
		case SecondLayer:
			ICLayoutViewVK9Stroke__DrawCandidateLine(pltObj, pEngineOutputInfo);
			break;
		case ThirdLayer:
			ICLayoutViewVK9Stroke__DrawAssociateLine(pltObj, pEngineOutputInfo);
			break;
		default:
			PT_Assert(0);
			break;
...
*/
static void ICLayoutViewVK9Stroke__DrawCandidateLine(GBLPVOID pltObj, PEngineOutputInfo pEngineOutputInfo)
{
	CLASE_THIS_POITER(CLayoutVK9Stroke, pltObj)
	CLASS_VIEW_THIS_POITER(CLayoutViewVK9Stroke, pltThis)
	...
	// 打印Log信息
	PT_PrintLogInfo(GBLOG_LAYOUTVIEW, ("***********************ICLayoutViewVK9Stroke__DrawCandidateLine() Draw Candidate image\n"));
...
*/
static void ICLayoutViewVK9Stroke__DrawAssociateLine(GBLPVOID pltObj, PEngineOutputInfo pEngineOutputInfo)
{
	CLASE_THIS_POITER(CLayoutVK9Stroke, pltObj)
	CLASS_VIEW_THIS_POITER(CLayoutViewVK9Stroke, pltThis)
	...
	if (pLayerConstInfo != NULL)
	{
		...
		// 打印Log信息
		PT_PrintLogInfo(GBLOG_LAYOUTVIEW, ("***********************ICLayoutViewVK9Stroke__DrawAssociateLine() Draw Candidate image\n"));
		PT_PrintLogInfo(GBLOG_LAYOUTVIEW, ("***********************Candidate Image ID = %d\n",iCandidateNomalImageId));
